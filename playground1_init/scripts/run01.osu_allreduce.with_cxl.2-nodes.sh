...
OUTPUT_DIR="output.osu_allreduce.with_cxl.2-nodes.$(date +%Y%m%dT%H%M%S)"
...
binary="/home/peng599/local/install/osu-micro-benchmarks/libexec/osu-micro-benchmarks/mpi/collective/osu_allreduce"
