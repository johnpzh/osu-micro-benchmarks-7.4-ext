...
OUTPUT_DIR="output.osu_multi_lat.with_cxl.2-nodes.$(date +%Y%m%dT%H%M%S)"
...
binary="/home/peng599/local/install/osu-micro-benchmarks/libexec/osu-micro-benchmarks/mpi/pt2pt/osu_multi_lat"
